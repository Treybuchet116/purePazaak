...
import com.treybuchet.purepazaak.databinding.ActivitySideDeckBinding
import com.treybuchet.purepazaak.util.PrefUtil

class SideDeckActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySideDeckBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySideDeckBinding.inflate(layoutInflater)
